...
map_df = map_df.rename(
    columns={'day 1': '18/07/2020', 'day 2': '19/07/2020', 'day 3': '20/07/2020', 'day 4': '21/07/2020',
             'day 5': '22/07/2020', 'day 6': '23/07/2020', 'day 7': '24/07/2020'})
...
app.layout = html.Div([
    ...
    html.Div(html.Img(
        src="https://raw.githubusercontent.com/d-vf/reliable-demo-2020/master/data/logos_reliable.png",
            style={
                'maxWidth': '50%',
                'maxHeight': '50%',
                'marginLeft': 'auto',
